...
public class Fragment_Lesson_2_1_Module extends Fragment {
    ...
    public Fragment_Lesson_2_1_Module() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lesson_2_1_module, container, false);
    ...
    public void initialization(View view) {
        scrollView = view.findViewById(R.id.module_2_1_scrollview);
        back = view.findViewById(R.id.module_2_1_back);
        logo = view.findViewById(R.id.module_2_1_logo);
        module_title_layout = view.findViewById(R.id.module_2_1_title_layout);
        module_title_text = view.findViewById(R.id.module_2_1_title_text);
        for (int i = 0; i < module_button.length; i++) {
            id = view.getResources().getIdentifier(
                    "module_2_1_button_" + (i + 1),
                    "id",
                    getActivity().getPackageName());
            module_button[i] = view.findViewById(id);
            id = view.getResources().getIdentifier(
                    "module_2_1_content_" + (i + 1),
                    "id",
                    getActivity().getPackageName());
            module_content[i] = view.findViewById(id);
        }
        module_previous_layout = view.findViewById(R.id.module_2_1_previous_layout);
        module_next_layout = view.findViewById(R.id.module_2_1_next_layout);
        module_previous_text = view.findViewById(R.id.module_2_1_previous_text);
        module_next_text = view.findViewById(R.id.module_2_1_next_text);
    ...
    public void onClickListener() {
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.hide(Fragment_Lesson_2_1_Module.this);
                ...
                public void onClick(View v) {
                    ...
                    if (previous_selected == (module_content.length - 1)) {
                        ...
                        id = getResources().getIdentifier(
                                "module_2_1_" + (previous_selected + 1) + "_title",
                                "string",
                                getActivity().getPackageName());
