...
public class Fragment_Menu_Simulation_Tutorial extends Fragment {
    ...
    ImageView exit, task_check;
    ZoomInImageView simulation_image;
    TextView task_text;
    Animation fade_in, fade_out;
    Vibrator vibrator;

    public Fragment_Menu_Simulation_Tutorial() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_menu_simulation_tutorial, container, false);
    ...
    public void initialization(View view) {
        ...
        simulation_image = view.findViewById(R.id.simulation_tutorial_image);
        task_text = view.findViewById(R.id.simulation_tutorial_task_text);
        task_check = view.findViewById(R.id.simulation_tutorial_task_check);
        screw_layout = view.findViewById(R.id.simulation_tutorial_case_screw_layout);
        items_text = view.findViewById(R.id.simulation_tutorial_item_text);
            ...
            public void onClick(View v) {
                ...
                view.findViewById(R.id.simulation_exit_check).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        fragmentTransaction.hide(Fragment_Menu_Simulation_Tutorial.this);
        ...
        simulation_image.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(MotionEvent e) {
                    ...
                    new_Task("Long press the screws to unscrew and drag it into the box(left side) and drop it. 4 screws remaining");
    ...
    public void taskTwo(View view) {
        ...
        screw_1 = view.findViewById(R.id.simulation_tutorial_case_screw_1);
        screw_2 = view.findViewById(R.id.simulation_tutorial_case_screw_2);
        screw_3 = view.findViewById(R.id.simulation_tutorial_case_screw_3);
        screw_4 = view.findViewById(R.id.simulation_tutorial_case_screw_4);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 0) {
                            ...
                            if (entered == true) {
                                ...
                                if (no_of_screw > 1) {
                                    new_Task("Long press the screws to unscrew and drag it into the box(left side) and drop it. (" + no_of_screw + " screws remaining)");
                                } else {
                                    new_Task("Long press the screws to unscrew and drag it into the box(left side) and drop it. " + no_of_screw + " screw remaining");
                                }
                                item_set[0] = 1;
                                ...
                                if (no_of_screw == 4) {
                                    new_Task("Double tap to see the front view");
                                    ...
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            ...
                                            public boolean onDoubleTap(MotionEvent e) {
                                                ...
                                                new_Task("Long press the case lid and put it into the left side,");
    ...
    public void taskThree(View view) {
        ConstraintLayout frontcaselid_layout = view.findViewById(R.id.simulation_tutorial_frontcaselid_layout);
        ImageView frontcaselid_item = view.findViewById(R.id.simulation_tutorial_frontcaselid_item);
                ...
                switch (state) {
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 1) {
                            ...
                            if (entered == true) {
                                item_set[1] = 1;
                                new_Task("Double tap to zoom in inside the case");
                                viewPager2.setCurrentItem(viewPager2.getCurrentItem() + 1);
                                ...
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        ...
                                        public boolean onDoubleTap(MotionEvent e) {
                                            ...
                                            new_Task("Double tap either the 24 pin or 4 pin to zoom into it");
                                            simulation_image.setEnabled(false);
                                            taskFour(view);
                                            return super.onDoubleTap(e);
                                        }
    ...
    public void taskFour(View view) {
        ConstraintLayout motherboard_psu_layout = view.findViewById(R.id.simulation_tutorial_motherboardpsucables_layout);
        ImageView four_pin = view.findViewById(R.id.simulation_tutorial_motherboardpsucables_4pin);
        ConstraintLayout motherboard_four_pin_psu_layout = view.findViewById(R.id.simulation_tutorial_motherboardpsucables4pin_layout);
        ImageView four_pin_item = view.findViewById(R.id.simulation_tutorial_motherboardpsucables4pin_item);
        ImageView twenty_four_pin = view.findViewById(R.id.simulation_tutorial_motherboardpsucables_24pin);
        ConstraintLayout motherboard_twenty_four_pin_psu_layout = view.findViewById(R.id.simulation_tutorial_motherboardpsucables24pin_layout);
        ImageView twenty_four_pin_item = view.findViewById(R.id.simulation_tutorial_motherboardpsucables24pin_item);
        ...
        four_pin.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                @Override
                public boolean onDoubleTap(MotionEvent e) {
                    new_Task("Long press the cable and drop it");
        ...
        four_pin_item.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                simulation_image.setEnabled(true);
                new_Task("Double tap to zoom out");
                    ...
                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                        ...
                        public boolean onDoubleTap(MotionEvent e) {
                            ...
                            if (twenty_four_pin.getVisibility() == View.VISIBLE) {
                                new_Task("Double tap the 24 pin to zoom in");
                                motherboard_psu_layout.setVisibility(View.VISIBLE);
                                simulation_image.setImageResource(R.drawable.simulation_image_4_1);
                            } else {
                                new_Task("Double tap the sata to zoom in");
                                motherboard_psu_layout.setVisibility(View.GONE);
                    ...
                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                        ...
                        public boolean onDoubleTap(MotionEvent e) {
                            ...
                            if (four_pin.getVisibility() == View.VISIBLE) {
                                new_Task("Double tap the 4 pin to zoom in");
    ...
    public void taskFive(View view) {
        simulation_image.setEnabled(false);
        ConstraintLayout motherboard_sata_layout = view.findViewById(R.id.simulation_tutorial_motherboardsata_layout);
        ImageView motherboard_sata = view.findViewById(R.id.simulation_tutorial_motherboardsata_item);
        ConstraintLayout motherboard_satacables_layout = view.findViewById(R.id.simulation_tutorial_motherboardpsatacables_layout);
        ImageView motherboard_satacables_1 = view.findViewById(R.id.simulation_tutorial_motherboardpsatacables_1_item);
        ImageView motherboard_satacables_2 = view.findViewById(R.id.simulation_tutorial_motherboardpsatacables_2_item);
        ...
        motherboard_sata.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                @Override
                public boolean onDoubleTap(MotionEvent e) {
                    new_Task("Long press the SATA cables and drop it. 2 remaining");
                ...
                if (motherboard_satacables_2.getVisibility() == View.GONE) {
                    ...
                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                            @Override
                            public boolean onDoubleTap(MotionEvent e) {
                                new_Task("Double tap to front panel pins to zoom into it");
                    ...
                    new_Task("Long press the SATA cables and drop it. 1 remaining");
    ...
    public void taskSix(View view) {
        simulation_image.setEnabled(false);
        ConstraintLayout motherboard_frontpanel_layout = view.findViewById(R.id.simulation_tutorial_motherboardfrontpanel_layout);
        ConstraintLayout motherboard_frontpanelcable_layout = view.findViewById(R.id.simulation_tutorial_motherboardfrontpanelcable_layout);
        ImageView motherboard_frontpanel = view.findViewById(R.id.simulation_tutorial_motherboardfrontpanel_item);
        ImageView motherboard_frontpanelcable = view.findViewById(R.id.simulation_tutorial_motherboardfrontpanelcable_item);
        ...
        motherboard_frontpanel.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                @Override
                public boolean onDoubleTap(MotionEvent e) {
                    new_Task("Long press the cables");
                        ...
                        public boolean onDoubleTap(MotionEvent e) {
                            ...
                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                    @Override
                                    public boolean onDoubleTap(MotionEvent e) {
                                        new_Task("Double tap to see the back view");
                                        simulation_image.setImageResource(R.drawable.simulation_image_5);
                                        simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                @Override
                                                public boolean onDoubleTap(MotionEvent e) {
                                                    new_Task("Long press the case lid and drop it into the box");
    ...
    public void taskSeven(View view) {
        ConstraintLayout backviewcaselid_layout = view.findViewById(R.id.simulation_tutorial_backviewcaselid_layout);
        ImageView backviewcaselid_item = view.findViewById(R.id.simulation_tutorial_backviewcaselid_item);
                ...
                switch (state) {
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 2) {
                            ...
                            if (entered == true) {
                                item_set[2] = 1;
                                new_Task("Double tap to zoom in on the bottom");
                                viewPager2.setCurrentItem(viewPager2.getCurrentItem() + 1);
                                ...
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        ...
                                        public boolean onDoubleTap(MotionEvent e) {
                                            ...
                                            new_Task("Double tap on the ssd area to zoom in");
                                            viewPager2.setEnabled(false);
                                            simulation_image.setEnabled(false);
                                            taskEight(view);
                                            return super.onDoubleTap(e);
    ...
    public void taskEight(View view) {
        ConstraintLayout storage_layout = view.findViewById(R.id.simulation_tutorial_storage_layout);
        ConstraintLayout ssd_cords_layout = view.findViewById(R.id.simulation_tutorial_ssd_cords_layout);
        ImageView storage = view.findViewById(R.id.simulation_tutorial_storage_item);
        ImageView ssd_psu_cords = view.findViewById(R.id.simulation_tutorial_ssd_cordspsu_item);
        ImageView ssd_sata_cords = view.findViewById(R.id.simulation_tutorial_ssd_cordssata_item);
        storage_layout.setVisibility(View.VISIBLE);
        storage.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                @Override
                public boolean onDoubleTap(MotionEvent e) {
                    new_Task("Long press on the cables to unplug it");
                    ...
                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                            ...
                            public boolean onDoubleTap(MotionEvent e) {
                                ...
                                new_Task("Double tap to remove the SSD holder in the case");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            ...
                                            ssd_cords_layout.setVisibility(View.GONE);
                                            new_Task("Double tap to see the bottom where you can locate the screws");
                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                    @Override
                                                    public boolean onDoubleTap(MotionEvent e) {
                                                        new_Task("Long press the screws and drop it into the box. 4 remaining");
    ...
    public void taskNine(View view) {
        char screws_gone[] = {'_', '_', '_', '_'};
        ConstraintLayout ssd_screw_layout = view.findViewById(R.id.simulation_tutorial_ssd_screw_layout);
        ImageView screw_1 = view.findViewById(R.id.simulation_tutorial_ssd_screw_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_tutorial_ssd_screw_2);
        ImageView screw_3 = view.findViewById(R.id.simulation_tutorial_ssd_screw_3);
        ImageView screw_4 = view.findViewById(R.id.simulation_tutorial_ssd_screw_4);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 3) {
                            ...
                            if (entered == true) {
                                ...
                                if (no_of_screw == 4) {
                                    new_Task("Double tap to view the SSD");
                                    viewPager2.setCurrentItem(viewPager2.getCurrentItem() + 1);
                                    simulation_image.setEnabled(true);
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                                new_Task("Long press the SSD and put it into the box");
                                                simulation_image.setImageResource(R.drawable.simulation_image_10_0);
    ...
    public void taskTen(View view) {
        ConstraintLayout ssd_ssd_layout = view.findViewById(R.id.simulation_tutorial_ssd_ssd_layout);
        ImageView ssd_ssd = view.findViewById(R.id.simulation_tutorial_ssd_ssd_item);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 4) {
                            ...
                            if (entered == true) {
                                ...
                                simulation_image.setEnabled(true);
                                new_Task("Double tap to put the holder back to the case");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            ...
                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                    @Override
                                                    public boolean onDoubleTap(MotionEvent e) {
                                                        new_Task("Double tap the HDD area zoom in");
    ...
    public void taskEleven(View view) {
        ...
        ImageView storage = view.findViewById(R.id.simulation_tutorial_storage_item);
        storage_layout.setVisibility(View.VISIBLE);
        ConstraintLayout hdd_cords_layout = view.findViewById(R.id.simulation_tutorial_hdd_cords_layout);
        ImageView hdd_psu_cords = view.findViewById(R.id.simulation_tutorial_hdd_cordspsu_item);
        ImageView hdd_sata_cords = view.findViewById(R.id.simulation_tutorial_hdd_cordssata_item);

        storage.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                @Override
                public boolean onDoubleTap(MotionEvent e) {
                    new_Task("Long press the cables to unplug it");
                    ...
                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                            ...
                            public boolean onDoubleTap(MotionEvent e) {
                                ...
                                new_Task("Double tap to remove the HDD holder to the case");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            simulation_image.setImageResource(R.drawable.simulation_image_16);
                                            new_Task("Double tap to see the screws attached");
                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                    @Override
                                                    public boolean onDoubleTap(MotionEvent e) {
                                                        new_Task("Long press the screws and put it into the box. 3 remaining");
    ...
    public void taskTwelve(View view) {
        ...
        ConstraintLayout hdd_screw_layout = view.findViewById(R.id.simulation_tutorial_hdd_screw_1_layout);
        ImageView screw_1 = view.findViewById(R.id.simulation_tutorial_hdd_screw_1_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_tutorial_hdd_screw_1_2);
        ImageView screw_3 = view.findViewById(R.id.simulation_tutorial_hdd_screw_1_3);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 5) {
                            ...
                            if (entered == true) {
                                ...
                                if (no_of_screw == 3) {
                                    new_Task("Double to see the other side screws");
                                    simulation_image.setEnabled(true);
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                                new_Task("Long press the screws to unscrew drag it into the box(left side) and drop it. 3 remaining");
    ...
    public void taskThirteen(View view) {
        char screws_gone[] = {'_', '_', '_'};
        ConstraintLayout hdd_screw_layout = view.findViewById(R.id.simulation_tutorial_hdd_screw_2_layout);
        ImageView screw_1 = view.findViewById(R.id.simulation_tutorial_hdd_screw_2_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_tutorial_hdd_screw_2_2);
        ImageView screw_3 = view.findViewById(R.id.simulation_tutorial_hdd_screw_2_3);
        hdd_screw_layout.setVisibility(View.VISIBLE);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 5) {
                            ...
                            if (entered == true) {
                                ...
                                if (no_of_screw == 3) {
                                    new_Task("Double tap to see the HDD");
                                    viewPager2.setCurrentItem(viewPager2.getCurrentItem() + 1);
                                    simulation_image.setEnabled(true);
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                                new_Task("Long press the HDD and put it into the box");
    ...
    public void taskFourteen(View view) {
        ConstraintLayout hdd_hdd_layout = view.findViewById(R.id.simulation_tutorial_hdd_hdd_layout);
        ImageView hdd_hdd = view.findViewById(R.id.simulation_tutorial_hdd_hdd_item);
                ...
                switch (state) {
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 6) {
                            ...
                            if (entered == true) {
                                item_set[viewPager2.getCurrentItem()] = 1;
                                new_Task("Double tap to put back the HDD holder to the case");
                                viewPager2.setCurrentItem(viewPager2.getCurrentItem() + 1);
                                        ...
                                        public boolean onDoubleTap(MotionEvent e) {
                                            ...
                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                    @Override
                                                    public boolean onDoubleTap(MotionEvent e) {
                                                        new_Task("Double tap to go to the upper part of the back");
                                                        simulation_image.setImageResource(R.drawable.simulation_image_20);
                                                        simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                                @Override
                                                                public boolean onDoubleTap(MotionEvent e) {
                                                                    new_Task("Long press the cable to remove it into the case");
    ...
    public void taskFifteen(View view) {
        viewPager2.setEnabled(false);
        ConstraintLayout four_pin_layout = view.findViewById(R.id.simulation_tutorial_4pin_layout);
        ImageView four_pin = view.findViewById(R.id.simulation_tutorial_4pin_item);
        ...
        four_pin.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                simulation_image.setEnabled(true);
                new_Task("Double tap to go to the bottom part");
                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                        @Override
                        public boolean onDoubleTap(MotionEvent e) {
                            new_Task("Double tap to remove the SATA cables into the case");
                                    ...
                                    public boolean onDoubleTap(MotionEvent e) {
                                        ...
                                        simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                @Override
                                                public boolean onDoubleTap(MotionEvent e) {
                                                    new_Task("Long press the SATA cables and put it into the box");
    ...
    public void taskSixteen(View view) {
        viewPager2.setEnabled(true);
        ConstraintLayout sata_layout = view.findViewById(R.id.simulation_tutorial_sata_layout);
        sata_layout.setVisibility(View.VISIBLE);
        ImageView sata_1 = view.findViewById(R.id.simulation_tutorial_sata_1);
        ImageView sata_2 = view.findViewById(R.id.simulation_tutorial_sata_2);
                            ...
                            if (entered == true) {
                                switch (tag) {
                                    ...
                                    case "2":
                                        ...
                                        sata_2.setVisibility(View.GONE);
                                        simulation_image.setEnabled(true);
                                        new_Task("Double tap to see the back view (PSU screws)");
                                        simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                @Override
                                                public boolean onDoubleTap(MotionEvent e) {
                                                    new_Task("Long press the screws to unscrew it and put it into the box. 4 screws remaining");
                                                    sata_layout.setVisibility(View.GONE);
    ...
    public void taskSeventeen(View view) {
        char screws_gone[] = {'_', '_', '_', '_'};
        ConstraintLayout psu_screw_layout = view.findViewById(R.id.simulation_tutorial_psu_screw_layout);
        ImageView screw_1 = view.findViewById(R.id.simulation_tutorial_psu_screw_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_tutorial_psu_screw_2);
        ImageView screw_3 = view.findViewById(R.id.simulation_tutorial_psu_screw_3);
        ImageView screw_4 = view.findViewById(R.id.simulation_tutorial_psu_screw_4);
                        ...
                        if (viewPager2.getCurrentItem() != 8) {
                            ...
                            if (entered == true) {
                                ...
                                if (no_of_screw == 4) {
                                    viewPager2.setCurrentItem(viewPager2.getCurrentItem() + 1);
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to go to the back");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                                simulation_image.setImageResource(R.drawable.simulation_image_26);
                                                new_Task("Double tap to remove the cables into the case");
                                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                        @Override
                                                        public boolean onDoubleTap(MotionEvent e) {
                                                            new_Task("Long press the PSU and drop it into the box");
    ...
    public void taskEighteen(View view) {
        ConstraintLayout psu_layout = view.findViewById(R.id.simulation_tutorial_psu_layout);
        ImageView psu = view.findViewById(R.id.simulation_tutorial_psu_item);
                            ...
                            if (entered == true) {
                                ...
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            new_Task("Double tap to view the front");
                                            simulation_image.setImageResource(R.drawable.simulation_image_28);
                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                    @Override
                                                    public boolean onDoubleTap(MotionEvent e) {
                                                        new_Task("Double tap to zoom into the case");
                                                        simulation_image.setImageResource(R.drawable.simulation_image_29);
                                                        simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                                @Override
                                                                public boolean onDoubleTap(MotionEvent e) {
                                                                    new_Task("Double tap on the videcard screws to zoom in");
    ...
    public void taskNineteen(View view) {
        ...
        ConstraintLayout vc_screw_layout = view.findViewById(R.id.simulation_tutorial_vc_screw_layout);
        ImageView screw_1 = view.findViewById(R.id.simulation_tutorial_vc_screw_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_tutorial_vc_screw_2);
        ConstraintLayout mobo_vc_screw_layout = view.findViewById(R.id.simulation_tutorial_mobo_vcscrew_layout);
        mobo_vc_screw_layout.setVisibility(View.VISIBLE);
        ImageView mobo_vc_screw = view.findViewById(R.id.simulation_tutorial_mobo_vcscrew);
        mobo_vc_screw.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                @Override
                public boolean onDoubleTap(MotionEvent e) {
                    new_Task("Long press the screws to unscrew and drag it into the box");
                        ...
                        if (viewPager2.getCurrentItem() != 10) {
                            ...
                            if (entered == true) {
                                ...
                                if (no_of_screw == 2) {
                                    viewPager2.setCurrentItem(viewPager2.getCurrentItem() + 1);
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to zoom out and see the videocard in full");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                                new_Task("Long press the videocard and put it into the box");
    ...
    public void taskTwenty(View view) {
        ConstraintLayout vc_layout = view.findViewById(R.id.simulation_tutorial_vc_layout);
        ImageView vc = view.findViewById(R.id.simulation_tutorial_vc_item);
                ...
                switch (state) {
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 11) {
                            ...
                            if (entered == true) {
                                item_set[viewPager2.getCurrentItem()] = 1;
                                new_Task("Double tap to zoom out and view the PC without a videocard");
                                viewPager2.setCurrentItem(viewPager2.getCurrentItem() + 1);
                                ...
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            new_Task("Double tap into the ram to zoom into it");
                                            taskTwentyOne(view);
                                            simulation_image.setEnabled(false);
    ...
    public void taskTwentyOne(View view) {
        ConstraintLayout mobo_ram_layout = view.findViewById(R.id.simulation_tutorial_mobo_ram_layout);
        mobo_ram_layout.setVisibility(View.VISIBLE);
        ImageView mobo_ram = view.findViewById(R.id.simulation_tutorial_mobo_ram_item);
        mobo_ram.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(MotionEvent e) {
                    ...
                    simulation_image.setEnabled(true);
                    new_Task("Double tap to view the slot lock (right side)");
                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                            @Override
                            public boolean onDoubleTap(MotionEvent e) {
                                simulation_image.setImageResource(R.drawable.simulation_image_35_0);
                                new_Task("Double tap to unlock");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            ...
                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                    ...
                                                    public boolean onDoubleTap(MotionEvent e) {
                                                        ...
                                                        new_Task("Double tap to view the slot lock (left side)");
                                                        simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                                @Override
                                                                public boolean onDoubleTap(MotionEvent e) {
                                                                            ...
                                                                            public boolean onDoubleTap(MotionEvent e) {
                                                                                ...
                                                                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                                                        ...
                                                                                        public boolean onDoubleTap(MotionEvent e) {
                                                                                            simulation_image.setEnabled(false);
                                                                                            new_Task("Long press the RAM and put it into the box. 4 RAM remaining");
    ...
    public void taskTwentyTwo(View view) {
        ...
        ConstraintLayout ram_layout = view.findViewById(R.id.simulation_tutorial_ram_layout);
        ImageView ram_1 = view.findViewById(R.id.simulation_tutorial_ram_1);
        ImageView ram_2 = view.findViewById(R.id.simulation_tutorial_ram_2);
        ImageView ram_3 = view.findViewById(R.id.simulation_tutorial_ram_3);
        ImageView ram_4 = view.findViewById(R.id.simulation_tutorial_ram_4);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 12) {
                            ...
                            if (entered == true) {
                                ...
                                if (no_of_screw > 0) {
                                    new_Task("Long press the screws to unscrew and drag it into the box(left side) and drop it. (" + no_of_screw + " RAM remaining)");
                                }
                                ...
                                if (no_of_screw == 4) {
                                    new_Task("Double tap to zoom out and view the PC without RAM");
                                    viewPager2.setCurrentItem(viewPager2.getCurrentItem() + 1);
                                    simulation_image.setEnabled(true);
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            ...
                                            public boolean onDoubleTap(MotionEvent e) {
                                                ...
                                                new_Task("Double tap on the CPU Fan cable to zoom into it");
    ...
    public void taskTwentyThree(View view) {
        viewPager2.setEnabled(false);
        ConstraintLayout heatsink_layout = view.findViewById(R.id.simulation_tutorial_heatsink_cable_layout);
        ImageView heatsink = view.findViewById(R.id.simulation_tutorial_heatsink_cable_item);
        ConstraintLayout mobo_heatsink_layout = view.findViewById(R.id.simulation_tutorial_mobo_heatsink_layout);
        mobo_heatsink_layout.setVisibility(View.VISIBLE);
        ImageView mobo_heatsink = view.findViewById(R.id.simulation_tutorial_mobo_heatsink_item);
        mobo_heatsink.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                @Override
                public boolean onDoubleTap(MotionEvent e) {
                    new_Task("Long press the cable to unplug it");
        ...
        heatsink.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                simulation_image.setEnabled(true);
                new_Task("Double tap to view the CPU Fan screws");
                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                        @Override
                        public boolean onDoubleTap(MotionEvent e) {
                            new_Task("Long press the screws to unscrew and put it into the box");
    ...
    public void taskTwentyFour(View view) {
        viewPager2.setEnabled(true);
        char screws_gone[] = {'_', '_'};
        ConstraintLayout heatink_screw_layout = view.findViewById(R.id.simulation_tutorial_heatsink_screw_1_layout);
        heatink_screw_layout.setVisibility(View.VISIBLE);
        ImageView screw_1 = view.findViewById(R.id.simulation_tutorial_heatsink_screw_1_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_tutorial_heatsink_screw_1_2);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 13) {
                            ...
                            if (entered == true) {
                                ...
                                if (no_of_screw == 2) {
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to view the other side screws");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
    ...
    public void taskTwentyFive(View view) {
        char screws_gone[] = {'_', '_'};
        ConstraintLayout heatink_screw_layout = view.findViewById(R.id.simulation_tutorial_heatsink_screw_2_layout);
        heatink_screw_layout.setVisibility(View.VISIBLE);
        ImageView screw_1 = view.findViewById(R.id.simulation_tutorial_heatsink_screw_2_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_tutorial_heatsink_screw_2_2);
                                ...
                                if (no_of_screw == 2) {
                                    ...
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                                new_Task("Long press the Heatsink and put it into the box");
    ...
    public void taskTwentySix(View view) {
        ConstraintLayout hs_layout = view.findViewById(R.id.simulation_tutorial_heatsink_layout);
        ImageView hs = view.findViewById(R.id.simulation_tutorial_heatsink_item);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 14) {
                            ...
                            if (entered == true) {
                                ...
                                simulation_image.setEnabled(true);
                                new_Task("Double tap to zoom in");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            new_Task("In the handle bar, swipe up to unlock the CPU from the CPU slot");
    ...
    public void taskTwentySeven(View view) {
        ConstraintLayout handle_layout = view.findViewById(R.id.simulation_tutorial_cpu_handle_layout);
        ImageView handle = view.findViewById(R.id.simulation_tutorial_cpu_handle);
            ...
            public void onSwipeTop() {
                ...
                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                        @Override
                        public boolean onDoubleTap(MotionEvent e) {
                            new_Task("Long press the CPU and put it into the box");
    ...
    public void taskTwentyEight(View view) {
        ConstraintLayout cpu_layout = view.findViewById(R.id.simulation_tutorial_cpu_layout);
        ImageView cpu = view.findViewById(R.id.simulation_tutorial_cpu);
                ...
                switch (state) {
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 15) {
                            ...
                            if (entered == true) {
                                item_set[viewPager2.getCurrentItem()] = 1;
                                new_Task("Double tap to zoom out and view the PC without the CPU and Heatsink");
                                viewPager2.setCurrentItem(viewPager2.getCurrentItem() + 1);
                                ...
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            new_Task("Double tap onto the motherboard screws to zoom in");
                                            taskTwentyNine(view);
                                            simulation_image.setEnabled(false);
    ...
    public void taskTwentyNine(View view) {
        char screws_gone[] = {'_', '_', '_'};
        ConstraintLayout screw_1_1_layout = view.findViewById(R.id.simulation_tutorial_mobo_screws_1_1_layout);
        ConstraintLayout screw_1_2_layout = view.findViewById(R.id.simulation_tutorial_mobo_screws_1_2_layout);
        ConstraintLayout screw_1_3_layout = view.findViewById(R.id.simulation_tutorial_mobo_screws_1_3_layout);
        ConstraintLayout screw_2_1_layout = view.findViewById(R.id.simulation_tutorial_mobo_screws_2_1_layout);
        ConstraintLayout screw_2_2_layout = view.findViewById(R.id.simulation_tutorial_mobo_screws_2_2_layout);
        ConstraintLayout screw_3_1_layout = view.findViewById(R.id.simulation_tutorial_mobo_screws_3_1_layout);
        ConstraintLayout screw_3_2_layout = view.findViewById(R.id.simulation_tutorial_mobo_screws_3_2_layout);
        ConstraintLayout screw_3_3_layout = view.findViewById(R.id.simulation_tutorial_mobo_screws_3_3_layout);
        ImageView screw_1_1 = view.findViewById(R.id.simulation_tutorial_mobo_screws_1_1);
        ImageView screw_1_2 = view.findViewById(R.id.simulation_tutorial_mobo_screws_1_2);
        ImageView screw_1_3 = view.findViewById(R.id.simulation_tutorial_mobo_screws_1_3);
        ImageView screw_2_1 = view.findViewById(R.id.simulation_tutorial_mobo_screws_2_1);
        ImageView screw_2_2 = view.findViewById(R.id.simulation_tutorial_mobo_screws_2_2);
        ImageView screw_3_1 = view.findViewById(R.id.simulation_tutorial_mobo_screws_3_1);
        ImageView screw_3_2 = view.findViewById(R.id.simulation_tutorial_mobo_screws_3_2);
        ImageView screw_3_3 = view.findViewById(R.id.simulation_tutorial_mobo_screws_3_3);
        ConstraintLayout layout = view.findViewById(R.id.simulation_tutorial_mobo_screws_layout);
        ImageView one = view.findViewById(R.id.simulation_tutorial_mobo_screws_1);
        ImageView two = view.findViewById(R.id.simulation_tutorial_mobo_screws_2);
        ImageView three = view.findViewById(R.id.simulation_tutorial_mobo_screws_3);
        ...
        one.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(MotionEvent e) {
                    ...
                    new_Task("Long press the screw and drag it into the box");
                        ...
                        if (viewPager2.getCurrentItem() != 16) {
                            ...
                            if (entered == true) {
                                ...
                                if (screw_1_1.getVisibility() == View.VISIBLE) {
                                    ...
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to go to the next screw");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                        ...
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            ...
                                            public boolean onDoubleTap(MotionEvent e) {
                                                ...
                                                if (id == R.drawable.simulation_image_46_0_123) {
                                                    new_Task("Long press the motherboard and put it into the box");
                                                    taskThirty(view);
                                                } else {
                                                    new_Task("Double tap on the screws that are still attach to the motherboard");
                                                    layout.setVisibility(View.VISIBLE);
                                                }
                                                simulation_image.setImageResource(id);
                                                return super.onDoubleTap(e);
    ...
    public void taskThirty(View view) {
        ConstraintLayout layout = view.findViewById(R.id.simulation_tutorial_motherboard_layout);
        layout.setVisibility(View.VISIBLE);
        ImageView image = view.findViewById(R.id.simulation_tutorial_motherboard_item);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() != 17) {
                            ...
                            if (entered == true) {
                                ...
                                simulation_image.setEnabled(true);
                                new_Task("Double tap to zoom out and view the case without other components");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            simulation_image.setImageResource(R.drawable.simulation_image_49);
                                            new_Task("Double tap to zoom back in");
                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                    @Override
                                                    public boolean onDoubleTap(MotionEvent e) {
                                                        taskThirtyOne(view);
                                                        simulation_image.setEnabled(false);
                                                        new_Task("In the left side where you had put all the components earlier, long press and drag the motherboard into the case");
                                                        simulation_image.setImageResource(R.drawable.simulation_image_48);
                                                        return super.onDoubleTap(e);
                                                    }
                                                });
    ...
    public void taskThirtyOne(View view) {
        ImageView item_real = view.findViewById(R.id.simulation_tutorial_item);
        item_real.setVisibility(View.VISIBLE);
        ImageView item = view.findViewById(R.id.simulation_tutorial_item_image);
    ...
    public void taskThirtyTwo(View view) {
        View motherboard_drag = view.findViewById(R.id.simulation_tutorial_motherboard_disassemble);
            ...
            public boolean onDrag(View v, DragEvent event) {
                ...
                switch (state) {
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() == 17) {
                            if (entered == true) {
                                new_Task("Double tap on the motherboard screw holes to zoom in");
    ...
    public void taskThirtyThree(View view) {
        ...
        screw_no--;
        View motherboard_screw_1 = view.findViewById(R.id.simulation_tutorial_mobo_screws_1_disassemble);
        View motherboard_screw_2 = view.findViewById(R.id.simulation_tutorial_mobo_screws_2_disassemble);
        View motherboard_screw_3 = view.findViewById(R.id.simulation_tutorial_mobo_screws_3_disassemble);
        ...
        View screw_1_1 = view.findViewById(R.id.simulation_tutorial_mobo_screws_1_1_disassemble);
        View screw_1_2 = view.findViewById(R.id.simulation_tutorial_mobo_screws_1_2_disassemble);
        View screw_1_3 = view.findViewById(R.id.simulation_tutorial_mobo_screws_1_3_disassemble);
        View screw_2_1 = view.findViewById(R.id.simulation_tutorial_mobo_screws_2_1_disassemble);
        View screw_2_2 = view.findViewById(R.id.simulation_tutorial_mobo_screws_2_2_disassemble);
        View screw_3_1 = view.findViewById(R.id.simulation_tutorial_mobo_screws_3_1_disassemble);
        View screw_3_2 = view.findViewById(R.id.simulation_tutorial_mobo_screws_3_2_disassemble);
        View screw_3_3 = view.findViewById(R.id.simulation_tutorial_mobo_screws_3_3_disassemble);

        motherboard_screw_1.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                @Override
                public boolean onDoubleTap(MotionEvent e) {
                    new_Task("Long press the item in the left side and drop it into the screw hole");
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() == 16) {
                            if (entered == true) {
                                screw_1_1.setVisibility(View.GONE);
                                simulation_image.setEnabled(true);
                                new_Task("Double tap to go to the next screw hole");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                ...
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        ...
                                        public boolean onDoubleTap(MotionEvent e) {
                                            ...
                                            simulation_image.setEnabled(false);
                                            if (id == 0) {
                                                new_Task("Double tap on the cpu slot to zoom in");
                                                simulation_image.setEnabled(true);
                                                simulation_image.setImageResource(R.drawable.simulation_image_46_0);
                                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                        ...
                                                        public boolean onDoubleTap(MotionEvent e) {
                                                            simulation_image.setEnabled(false);
                                                            new_Task("In the left side, long press it and drop it into the CPU slot");
                                                            simulation_image.setImageResource(R.drawable.simulation_image_45_1);
                                                            taskThirtyFour(view);
                                                            return super.onDoubleTap(e);
                                                        }
    ...
    public void taskThirtyFour(View view) {
        View cpu_drag = view.findViewById(R.id.simulation_tutorial_cpu_disassemble);
                            ...
                            if (entered == true) {
                                ...
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            new_Task("Swipe down the handle bar");
                                            taskThirtyFive(view);
                                            simulation_image.setEnabled(false);
                                            simulation_image.setImageResource(R.drawable.simulation_image_44_1);
                                            return super.onDoubleTap(e);
    ...
    public void taskThirtyFive(View view) {
        View handle = view.findViewById(R.id.simulation_tutorial_cpu_handle_disassemble);
                ...
                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                        ...
                        public boolean onDoubleTap(MotionEvent e) {
                            ...
                            taskThirtySix(view);
                            simulation_image.setEnabled(false);
                            new_Task("In the left side, long press it and drop it into the heatsink slot. (Reminder: In a real PC, you must first put a thermal paste so the CPU can have a proper cooling)");
                            simulation_image.setImageResource(R.drawable.simulation_image_43_1);
                            return super.onDoubleTap(e);
                        }
                    });
    ...
    public void taskThirtySix(View view) {
        View heatsink_drag = view.findViewById(R.id.simulation_tutorial_heatsink_item_disassemble);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() == 14) {
                            if (entered == true) {
                                ...
                                simulation_image.setEnabled(true);
                                new_Task("Double tap to put the screws");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            ...
                                            simulation_image.setEnabled(false);
                                            new_Task("In the left side, long press it and drop it into the screw holes");
    ...
    public void taskThirtySeven(View view) {
        View screw_1 = view.findViewById(R.id.simulation_tutorial_heatsink_screw_2_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_tutorial_heatsink_screw_2_2_disassemble);
                        ...
                        if (viewPager2.getCurrentItem() == 13) {
                            if (entered == true) {
                                ...
                                if (screw_2.getVisibility() == View.GONE) {
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to see the other screw holes");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
    ...
    public void taskThirtyEight(View view) {
        View screw1 = view.findViewById(R.id.simulation_tutorial_heatsink_screw_1_1_disassemble);
        View screw2 = view.findViewById(R.id.simulation_tutorial_heatsink_screw_1_2_disassemble);
                        ...
                        if (viewPager2.getCurrentItem() == 13) {
                            if (entered == true) {
                                ...
                                if (screw2.getVisibility() != View.VISIBLE) {
                                    ...
                                    viewPager2.setCurrentItem(viewPager2.getCurrentItem() - 1);
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to view the CPU fan");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                                new_Task("Long press the cable and drop it into the CPU fan pin");
                                                simulation_image.setImageResource(R.drawable.simulation_image_40_1);
                                                simulation_image.setEnabled(false);
                                                taskThirtyNine(view);
                                                return super.onDoubleTap(e);
                        ...
                        if (viewPager2.getCurrentItem() == 13) {
                            if (entered1 == true) {
                                ...
                                if (screw1.getVisibility() == View.GONE) {
                                    ...
                                    viewPager2.setCurrentItem(viewPager2.getCurrentItem() - 1);
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to view the CPU fan pin");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
    ...
    public void taskThirtyNine(View view) {
        ImageView cable = view.findViewById(R.id.simulation_tutorial_heatsink_cable_item_disassemble);
        View cable_drag = view.findViewById(R.id.simulation_tutorial_heatsink_cable_drag_disassemble);
                        ...
                        if (entered == true) {
                            ...
                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                    @Override
                                    public boolean onDoubleTap(MotionEvent e) {
                                        new_Task("Double tap into the RAM slot to zoom in");
                                        taskForty(view);
                                        simulation_image.setEnabled(false);
                                        simulation_image.setImageResource(R.drawable.simulation_image_39);
                                        return super.onDoubleTap(e);
    ...
    public void taskForty(View view) {
        View mobo_ram = view.findViewById(R.id.simulation_tutorial_mobo_ram_item_disassemble);
        ...
        mobo_ram.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(MotionEvent e) {
                    taskFortyOne(view);
                    new_Task("In the left side, long press it and drop it into the RAM slots");
                    mobo_ram.setVisibility(View.GONE);
    ...
    public void taskFortyOne(View view) {
        View ram1 = view.findViewById(R.id.simulation_tutorial_ram_disassemble);
                        ...
                        if (viewPager2.getCurrentItem() == 12) {
                            if (entered == true) {
                                if (simulation_image.getDrawable().getConstantState() == getResources().getDrawable(R.drawable.simulation_image_38_0).getConstantState()) {
                                    ...
                                    viewPager2.setCurrentItem(viewPager2.getCurrentItem() - 1);
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to zoom into the RAM slot lock (right side)");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                                new_Task("Double tap to lock it");
                                                simulation_image.setImageResource(R.drawable.simulation_image_37_1);
                                                taskFortyTwo(view);
                                                return super.onDoubleTap(e);
                                            }
                                                                ...
                                                                public boolean onDoubleTap(MotionEvent e) {
                                                                    ...
                                                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                                            @Override
                                                                            public boolean onDoubleTap(MotionEvent e) {
                                                                                new_Task("Double tap into the videocard slot");
                                                                                simulation_image.setImageResource(R.drawable.simulation_image_33);
                                                                                simulation_image.setEnabled(false);
                                                                                taskFortyThree(view);
                                                                                return super.onDoubleTap(e);
    ...
    public void taskFortyThree(View view) {
        View vc = view.findViewById(R.id.simulation_tutorial_videocard_disassemble);
        ...
        vc.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(MotionEvent e) {
                    vc.setVisibility(View.GONE);
                    new_Task("In the left side, long press the videocard and drop it into the GPU slot");
                    simulation_image.setImageResource(R.drawable.simulation_image_32_1);
                    taskFortyFour(view);
                    return super.onDoubleTap(e);
                }
    ...
    public void taskFortyFour(View view) {
        View videocard = view.findViewById(R.id.simulation_tutorial_vc_item_disassemble);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() == 11) {
                            if (entered == true) {
                                ...
                                simulation_image.setEnabled(true);
                                new_Task("Double tap to screw it");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            taskFortyFive(view);
                                            simulation_image.setEnabled(false);
                                            new_Task("In the left side, long press the videocard screws and drop it in the screw holes");
    ...
    public void taskFortyFive(View view) {
        View screw1 = view.findViewById(R.id.simulation_tutorial_vc_screw_1_disassemble);
        View screw2 = view.findViewById(R.id.simulation_tutorial_vc_screw_2_disassemble);
        screw1.setVisibility(View.VISIBLE);
        screw2.setVisibility(View.VISIBLE);
                                            ...
                                            public boolean onDoubleTap(MotionEvent e) {
                                                ...
                                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                        ...
                                                        public boolean onDoubleTap(MotionEvent e) {
                                                            simulation_image.setImageResource(R.drawable.simulation_image_29);
                                                            new_Task("Double tap to view the back side");
                                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                                    @Override
                                                                    public boolean onDoubleTap(MotionEvent e) {
                                                                        simulation_image.setImageResource(R.drawable.simulation_image_28);
                                                                        new_Task("Double tap to zoom into the PSU area");
                                                                        simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                                            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                                                @Override
                                                                                public boolean onDoubleTap(MotionEvent e) {
                                                                                    simulation_image.setImageResource(R.drawable.simulation_image_27_1);
                                                                                    new_Task("In the left side, long press the PSU and drop it into the case");
                                                                                    simulation_image.setEnabled(false);
                                                                                    taskFortySix(view);
                                                                                    return super.onDoubleTap(e);
                                                                                }
    ...
    public void taskFortySix(View view) {
        View psu = view.findViewById(R.id.simulation_tutorial_psu_item_disassemble);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() == 9) {
                            if (entered == true) {
                                ...
                                psu.setVisibility(View.GONE);
                                simulation_image.setEnabled(true);
                                new_Task("Double tap so that the cable would go into the case");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            simulation_image.setImageResource(R.drawable.simulation_image_26);
                                            new_Task("Double tap into the PSU to screw it");
                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                    @Override
                                                    public boolean onDoubleTap(MotionEvent e) {
    ...
    public void taskFortySeven(View view) {
        ...
        View screw_1 = view.findViewById(R.id.simulation_tutorial_psu_screw_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_tutorial_psu_screw_2_disassemble);
        View screw_3 = view.findViewById(R.id.simulation_tutorial_psu_screw_3_disassemble);
        View screw_4 = view.findViewById(R.id.simulation_tutorial_psu_screw_4_disassemble);
        screw_1.setVisibility(View.VISIBLE);
        screw_2.setVisibility(View.VISIBLE);
                                ...
                                if (simulation_image.getDrawable().getConstantState() == getResources().getDrawable(R.drawable.simulation_image_25_0).getConstantState()) {
                                    ...
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                                new_Task("In the left side, long press the SATA cable and drop it in the floor");
                                                simulation_image.setImageResource(R.drawable.simulation_image_24_3);
                                                simulation_image.setEnabled(false);
                                                taskFortyEight(view);
                                                return super.onDoubleTap(e);
    ...
    public void taskFortyEight(View view) {
        View sata = view.findViewById(R.id.simulation_tutorial_sata_1_disassemble);
                                ...
                                if (simulation_image.getDrawable().getConstantState() == getResources().getDrawable(R.drawable.simulation_image_24_0).getConstantState()) {
                                    ...
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            ...
                                            public boolean onDoubleTap(MotionEvent e) {
                                                simulation_image.setImageResource(R.drawable.simulation_image_23);
                                                new_Task("Double tap so the sata cable will go through the PC case");
                                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                        @Override
                                                        public boolean onDoubleTap(MotionEvent e) {
                                                            simulation_image.setImageResource(R.drawable.simulation_image_22);
                                                            new_Task("Double tap to view the upper part");
                                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                                    @Override
                                                                    public boolean onDoubleTap(MotionEvent e) {
                                                                        new_Task("Long press the cable and drop it into the hole");
                                                                        simulation_image.setImageResource(R.drawable.simulation_image_21_1);
                                                                        simulation_image.setEnabled(false);
                                                                        taskFortyNine(view);
                                                                        return super.onDoubleTap(e);
    ...
    public void taskFortyNine(View view) {
        ImageView cable = view.findViewById(R.id.simulation_tutorial_4pin_disassemble);
        View cable_drag = view.findViewById(R.id.simulation_tutorial_4pin_item_disassemble);
        cable_drag.setVisibility(View.VISIBLE);
        cable.setVisibility(View.VISIBLE);
                ...
                switch (state) {
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (entered == true) {
                            ...
                            cable_drag.setVisibility(View.GONE);
                            simulation_image.setEnabled(true);
                            new_Task("Double tap to view the bottom part");
                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                    @Override
                                    public boolean onDoubleTap(MotionEvent e) {
                                        new_Task("Double tap the HDD holder");
                                        taskFifty(view);
                                        simulation_image.setEnabled(false);
                                        simulation_image.setImageResource(R.drawable.simulation_image_20);
                                        return super.onDoubleTap(e);
    ...
    public void taskFifty(View view) {
        View storage = view.findViewById(R.id.simulation_tutorial_storage_item_disassemble);
        ...
        storage.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(MotionEvent e) {
                    ...
                    simulation_image.setImageResource(R.drawable.simulation_image_19);
                    simulation_image.setEnabled(true);
                    new_Task("Double tap to remove the HDD holder");
                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                            @Override
                            public boolean onDoubleTap(MotionEvent e) {
                                storage.setVisibility(View.GONE);
                                taskFiftyOne(view);
                                new_Task("In the left side, long press the HDD and drop it into the HDD holder");
                                simulation_image.setImageResource(R.drawable.simulation_image_18_1);
                                simulation_image.setEnabled(false);
                                return super.onDoubleTap(e);
                            }
    ...
    public void taskFiftyOne(View view) {
        View hdd = view.findViewById(R.id.simulation_tutorial_hdd_hdd_item_disassemble);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() == 6) {
                            if (entered == true) {
                                ...
                                simulation_image.setEnabled(true);
                                new_Task("Double tap to put a screw in it");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            new_Task("In the left side, long press the screws and drop it into the screw holes");
    ...
    public void taskFiftyTwo(View view) {
        char screws_gone[] = {'1', '2', '3'};
        View screw_1 = view.findViewById(R.id.simulation_tutorial_hdd_screw_2_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_tutorial_hdd_screw_2_2_disassemble);
        View screw_3 = view.findViewById(R.id.simulation_tutorial_hdd_screw_2_3_disassemble);
        screw_1.setVisibility(View.VISIBLE);
        screw_2.setVisibility(View.VISIBLE);
        screw_3.setVisibility(View.VISIBLE);
                        ...
                        if (viewPager2.getCurrentItem() == 5) {
                            if (entered == true) {
                                ...
                                if (simulation_image.getDrawable().getConstantState() == getResources().getDrawable(R.drawable.simulation_image_17_1).getConstantState()) {
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to view the other screw holes");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
    ...
    public void taskFiftyThree(View view) {
        char screws_gone[] = {'1', '2', '3'};
        View screw_1 = view.findViewById(R.id.simulation_tutorial_hdd_screw_1_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_tutorial_hdd_screw_1_2_disassemble);
        View screw_3 = view.findViewById(R.id.simulation_tutorial_hdd_screw_1_3_disassemble);
        screw_1.setVisibility(View.VISIBLE);
        screw_2.setVisibility(View.VISIBLE);
        screw_3.setVisibility(View.VISIBLE);
                                ...
                                if (simulation_image.getDrawable().getConstantState() == getResources().getDrawable(R.drawable.simulation_image_17_0).getConstantState()) {
                                    ...
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            ...
                                            public boolean onDoubleTap(MotionEvent e) {
                                                simulation_image.setImageResource(R.drawable.simulation_image_16);
                                                new_Task("Double tap to put the HDD holder into the case");
                                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                        @Override
                                                        public boolean onDoubleTap(MotionEvent e) {
                                                            ...
                                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                                    @Override
                                                                    public boolean onDoubleTap(MotionEvent e) {
                                                                        new_Task("Long press the cable and plug it into port");
                                                                        simulation_image.setImageResource(R.drawable.simulation_image_14_3);
                                                                        simulation_image.setEnabled(false);
                                                                        taskFiftyFour(view);
                                                                        return super.onDoubleTap(e);
    ...
    public void taskFiftyFour(View view) {
        ImageView psu = view.findViewById(R.id.simulation_tutorial_hdd_cordspsu_disassemble);
        ImageView sata = view.findViewById(R.id.simulation_tutorial_hdd_cordssata_disassemble);
        View psu_drag = view.findViewById(R.id.simulation_tutorial_hdd_cordspsu_item_disassemble);
        View sata_drag = view.findViewById(R.id.simulation_tutorial_hdd_cordssata_item_disassemble);
        psu.setVisibility(View.VISIBLE);
        sata.setVisibility(View.VISIBLE);
                            ...
                            if (entered == true) {
                                ...
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        ...
                                        public boolean onDoubleTap(MotionEvent e) {
                                            taskFiftyFive(view);
                                            new_Task("Double tap the SSD area to zoom in");
                                            simulation_image.setEnabled(false);
                                            simulation_image.setImageResource(R.drawable.simulation_image_13);
                                            return super.onDoubleTap(e);
                                        }
    ...
    public void taskFiftyFive(View view) {
        ...
        storage.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(MotionEvent e) {
                    storage.setVisibility(View.GONE);
                    new_Task("Double tap to remove the SSD holder");
                    simulation_image.setImageResource(R.drawable.simulation_image_12);
                    simulation_image.setEnabled(true);
                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                            ...
                            public boolean onDoubleTap(MotionEvent e) {
                                storage.setVisibility(View.GONE);
                                taskFiftySix(view);
                                new_Task("In the left side, long press the SSD and drop it into the SSD holder");
                                simulation_image.setImageResource(R.drawable.simulation_image_11);
                                simulation_image.setEnabled(false);
                                return super.onDoubleTap(e);
                            }
    ...
    public void taskFiftySix(View view) {
        View ssd = view.findViewById(R.id.simulation_tutorial_ssd_ssd_item_disassemble);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() == 4) {
                            if (entered == true) {
                                ...
                                simulation_image.setEnabled(true);
                                new_Task("Double tap to view the screw holes");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            new_Task("In the left side, long press the SSD screws and drop it into the SSD holder screw hole");
    ...
    public void taskFiftySeven(View view) {
        char screws_gone[] = {'1', '2', '3', '4'};
        View screw_1 = view.findViewById(R.id.simulation_tutorial_ssd_screw_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_tutorial_ssd_screw_2_disassemble);
        View screw_3 = view.findViewById(R.id.simulation_tutorial_ssd_screw_3_disassemble);
        View screw_4 = view.findViewById(R.id.simulation_tutorial_ssd_screw_4_disassemble);
        screw_1.setVisibility(View.VISIBLE);
        screw_2.setVisibility(View.VISIBLE);
        screw_3.setVisibility(View.VISIBLE);
        screw_4.setVisibility(View.VISIBLE);
                        ...
                        if (viewPager2.getCurrentItem() == 3) {
                            if (entered == true) {
                                ...
                                if (simulation_image.getDrawable().getConstantState() == getResources().getDrawable(R.drawable.simulation_image_10_1).getConstantState()) {
                                    ...
                                    viewPager2.setCurrentItem(viewPager2.getCurrentItem() - 1);
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to view the SSD holder upper part");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                            @Override
                                            public boolean onDoubleTap(MotionEvent e) {
                                                simulation_image.setImageResource(R.drawable.simulation_image_10_0);
                                                new_Task("Double tap to put the SSD holder into the case");
                                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                        @Override
                                                        public boolean onDoubleTap(MotionEvent e) {
                                                            ...
                                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                                    @Override
                                                                    public boolean onDoubleTap(MotionEvent e) {
                                                                        new_Task("Long press the cable and drop it into the plug");
                                                                        simulation_image.setImageResource(R.drawable.simulation_image_8_3);
                                                                        simulation_image.setEnabled(false);
                                                                        taskFiftyEight(view);
                                                                        return super.onDoubleTap(e);
    ...
    public void taskFiftyEight(View view) {
        ImageView psu = view.findViewById(R.id.simulation_tutorial_ssd_cordspsu_disassemble);
        ImageView sata = view.findViewById(R.id.simulation_tutorial_ssd_cordssata_disassemble);
        View psu_drag = view.findViewById(R.id.simulation_tutorial_ssd_cordspsu_item_disassemble);
        View sata_drag = view.findViewById(R.id.simulation_tutorial_ssd_cordssata_item_disassemble);
        psu.setVisibility(View.VISIBLE);
        sata.setVisibility(View.VISIBLE);
        psu_drag.setVisibility(View.VISIBLE);
        sata_drag.setVisibility(View.VISIBLE);
                                            ...
                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                    ...
                                                    public boolean onDoubleTap(MotionEvent e) {
                                                        taskFiftyNine(view);
                                                        simulation_image.setEnabled(false);
                                                        new_Task("In the left side, long press the case lid and drop it into the case");
                                                        simulation_image.setImageResource(R.drawable.simulation_image_6_1);
                                                        return super.onDoubleTap(e);
                                                    }
                                                });
    ...
    public void taskFiftyNine(View view) {
        View backcase_lid = view.findViewById(R.id.simulation_tutorial_backviewcaselid_item_disassemble);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() == 2) {
                            if (entered == true) {
                                ...
                                simulation_image.setEnabled(true);
                                new_Task("Double tap to view the front view");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            ...
                                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                                    @Override
                                                    public boolean onDoubleTap(MotionEvent e) {
                                                        new_Task("Double tap into the front panel pins to zoom into it");
                                                        simulation_image.setImageResource(R.drawable.simulation_image_4_5);
                                                        taskSixty(view);
                                                        simulation_image.setEnabled(false);
                                                        return super.onDoubleTap(e);
    ...
    public void taskSixty(View view) {
        View frontcable = view.findViewById(R.id.simulation_tutorial_motherboardfrontpanel_item_disassemble);
        ...
        frontcable.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(MotionEvent e) {
                    ...
                    taskSixtyOne(view);
                    new_Task("Long press the cable and drop it into the pin");
                    simulation_image.setImageResource(R.drawable.simulation_image_4_5_1);
                    simulation_image.setEnabled(true);
                    return super.onDoubleTap(e);
                }
    ...
    public void taskSixtyOne(View view) {
        ImageView frontcable = view.findViewById(R.id.simulation_tutorial_motherboardfrontpanelcable_disassemble);
        View frontcable_drag = view.findViewById(R.id.simulation_tutorial_motherboardfrontpanelcable_item_disassemble);
        frontcable.setVisibility(View.VISIBLE);
                        ...
                        if (entered == true) {
                            ...
                            simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                    ...
                                    public boolean onDoubleTap(MotionEvent e) {
                                        taskSixtyTwo(view);
                                        new_Task("Double tap the SATA port");
                                        simulation_image.setImageResource(R.drawable.simulation_image_4_4);
                                        simulation_image.setEnabled(false);
                                        return super.onDoubleTap(e);
                                    }
    ...
    public void taskSixtyTwo(View view) {
        View sata = view.findViewById(R.id.simulation_tutorial_motherboardsata_item_disassemble);
        sata.setVisibility(View.VISIBLE);
        sata.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(MotionEvent e) {
                    sata.setVisibility(View.GONE);
                    taskSixtyThree(view);
                    new_Task("Long press the cable and plug it into the port");
                    simulation_image.setImageResource(R.drawable.simulation_image_4_4_3);
                    simulation_image.setEnabled(true);
                    return super.onDoubleTap(e);
                }
    ...
    public void taskSixtyThree(View view) {
        ImageView sata_1 = view.findViewById(R.id.simulation_tutorial_motherboardpsatacables_1_disassemble);
        ImageView sata_2 = view.findViewById(R.id.simulation_tutorial_motherboardpsatacables_2_disassemble);
        View sata_1_drag = view.findViewById(R.id.simulation_tutorial_motherboardpsatacables_1_item_disassemble);
        View sata_2_drag = view.findViewById(R.id.simulation_tutorial_motherboardpsatacables_2_item_disassemble);
                                ...
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        ...
                                        public boolean onDoubleTap(MotionEvent e) {
                                            taskSixtyFour(view);
                                            simulation_image.setEnabled(false);
                                            new_Task("Double tap either 4 pin or 24 pin to zoom into it");
                                            simulation_image.setImageResource(R.drawable.simulation_image_4_3);
                                            return super.onDoubleTap(e);
                                        }
                                    });
    ...
    public void taskSixtyFour(View view) {
        View four_pin = view.findViewById(R.id.simulation_tutorial_motherboardpsucables_4pin_disassemble);
        View twentyfour_pin = view.findViewById(R.id.simulation_tutorial_motherboardpsucables_24pin_disassemble);
        four_pin.setVisibility(View.VISIBLE);
        twentyfour_pin.setVisibility(View.VISIBLE);
        View twentyfour_pin_drag = view.findViewById(R.id.simulation_tutorial_motherboardpsucables24pin_item_disassemble);
        View four_pin_drag = view.findViewById(R.id.simulation_tutorial_motherboardpsucables4pin_item_disassemble);
        ImageView twentyfour_pin_item = view.findViewById(R.id.simulation_tutorial_motherboardpsucables24pin_disassemble);
        ImageView four_pin_item = view.findViewById(R.id.simulation_tutorial_motherboardpsucables4pin_disassemble);
        ...
        four_pin.setOnTouchListener(new View.OnTouchListener() {
            private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(MotionEvent e) {
                    ...
                    simulation_image.setImageResource(R.drawable.simulation_image_4_1_1);
                    simulation_image.setEnabled(true);
                    new_Task("Long press the cable and plug it into the pin");
                    return super.onDoubleTap(e);
                }
            });
    ...
    public void taskSixtyFive(View view) {
        View frontcase_lid = view.findViewById(R.id.simulation_tutorial_frontcaselid_item_disassemble);
                    ...
                    case DragEvent.ACTION_DRAG_ENDED:
                        if (viewPager2.getCurrentItem() == 1) {
                            if (entered == true) {
                                ...
                                simulation_image.setEnabled(true);
                                new_Task("Double tap to screw the case lids");
                                simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                    private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                                        @Override
                                        public boolean onDoubleTap(MotionEvent e) {
                                            new_Task("In the left side, long press the case lids screws and drop it into the screw holes");
    ...
    public void taskSixtySix(View view) {
        char screws_gone[] = {'1', '2', '3', '4'};
        View screw_1 = view.findViewById(R.id.simulation_tutorial_case_screw_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_tutorial_case_screw_2_disassemble);
        View screw_3 = view.findViewById(R.id.simulation_tutorial_case_screw_3_disassemble);
        View screw_4 = view.findViewById(R.id.simulation_tutorial_case_screw_4_disassemble);
        screw_1.setVisibility(View.VISIBLE);
        screw_2.setVisibility(View.VISIBLE);
        screw_3.setVisibility(View.VISIBLE);
        screw_4.setVisibility(View.VISIBLE);
                        ...
                        if (viewPager2.getCurrentItem() == 0) {
                            if (entered == true) {
                                ...
                                if (simulation_image.getDrawable().getConstantState() == getResources().getDrawable(R.drawable.simulation_image_1).getConstantState()) {
                                    item_set[viewPager2.getCurrentItem()] = 0;
                                    simulation_image.setEnabled(true);
                                    new_Task("Double tap to see the full view");
                                    simulation_image.setOnTouchListener(new View.OnTouchListener() {
                                        private GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
    ...
    public void done() {
        ...
        String status = database.viewSimulationStatus("Tutorial");
        switch (status) {
            case "Active":
                database.updateSimulationStatus("Tutorial", "Done");
                database.updateSimulationStatus("Practice", "Active");
                database.updateSimulationStatus("Time", "Active");
                database.updateStatus("Done");
                if (isConnectedToInternet() == true) {
                    php_Update("Done", "Practice");
                }
                break;
        }
    }

    public void new_Task(String text) {
        task_check.setVisibility(View.VISIBLE);
        task_check.startAnimation(fade_out);
        task_text.startAnimation(fade_out);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                task_text.setText(text);
                fade_in = AnimationUtils.loadAnimation(getActivity().getApplicationContext(),
                        R.anim.fade_in);
                task_text.startAnimation(fade_in);
                task_check.clearAnimation();
                task_check.setVisibility(View.INVISIBLE);
            }
        }, 1000);
    }
    ...
    private void php_Update(String status, String current_status) {
        ...
        class getLogin extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    URL url = new URL("https://pcad-gbbs.000webhostapp.com/android/android_update_status.php");
                    ...
                    String post_data = URLEncoder.encode("student_id", "UTF-8") + "=" + URLEncoder.encode(database.get_ID(), "UTF-8") + "&"
