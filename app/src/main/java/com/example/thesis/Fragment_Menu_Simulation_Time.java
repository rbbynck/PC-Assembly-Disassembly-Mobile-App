...
public class Fragment_Menu_Simulation_Time extends Fragment {
    ...
    ImageView exit, simulation_image;
    ...
    public Fragment_Menu_Simulation_Time() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_menu_simulation_time, container, false);
        ...
        Runnable timerRunnable = new Runnable() {
            ...
            public void run() {
                ...
                time.setText("Time: " + String.format("%d:%02d", minutes, seconds));
    ...
    public void initialization(View view) {
        ...
        simulation_image = view.findViewById(R.id.simulation_time_image);
        screw_layout = view.findViewById(R.id.simulation_time_case_screw_layout);
        items_text = view.findViewById(R.id.simulation_time_item_text);
        time = view.findViewById(R.id.simulation_time_time);
            ...
            public void onClick(View v) {
                ...
                view.findViewById(R.id.simulation_exit_check).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        fragmentTransaction.hide(Fragment_Menu_Simulation_Time.this);
    ...
    public void taskTwo(View view) {
        ...
        screw_1 = view.findViewById(R.id.simulation_time_case_screw_1);
        screw_2 = view.findViewById(R.id.simulation_time_case_screw_2);
        screw_3 = view.findViewById(R.id.simulation_time_case_screw_3);
        screw_4 = view.findViewById(R.id.simulation_time_case_screw_4);
    ...
    public void taskThree(View view) {
        ConstraintLayout frontcaselid_layout = view.findViewById(R.id.simulation_time_frontcaselid_layout);
        ImageView frontcaselid_item = view.findViewById(R.id.simulation_time_frontcaselid_item);
    ...
    public void taskFour(View view) {
        ConstraintLayout motherboard_psu_layout = view.findViewById(R.id.simulation_time_motherboardpsucables_layout);
        ImageView four_pin = view.findViewById(R.id.simulation_time_motherboardpsucables_4pin);
        ConstraintLayout motherboard_four_pin_psu_layout = view.findViewById(R.id.simulation_time_motherboardpsucables4pin_layout);
        ImageView four_pin_item = view.findViewById(R.id.simulation_time_motherboardpsucables4pin_item);
        ImageView twenty_four_pin = view.findViewById(R.id.simulation_time_motherboardpsucables_24pin);
        ConstraintLayout motherboard_twenty_four_pin_psu_layout = view.findViewById(R.id.simulation_time_motherboardpsucables24pin_layout);
        ImageView twenty_four_pin_item = view.findViewById(R.id.simulation_time_motherboardpsucables24pin_item);
    ...
    public void taskFive(View view) {
        simulation_image.setEnabled(false);
        ConstraintLayout motherboard_sata_layout = view.findViewById(R.id.simulation_time_motherboardsata_layout);
        ImageView motherboard_sata = view.findViewById(R.id.simulation_time_motherboardsata_item);
        ConstraintLayout motherboard_satacables_layout = view.findViewById(R.id.simulation_time_motherboardpsatacables_layout);
        ImageView motherboard_satacables_1 = view.findViewById(R.id.simulation_time_motherboardpsatacables_1_item);
        ImageView motherboard_satacables_2 = view.findViewById(R.id.simulation_time_motherboardpsatacables_2_item);
    ...
    public void taskSix(View view) {
        simulation_image.setEnabled(false);
        ConstraintLayout motherboard_frontpanel_layout = view.findViewById(R.id.simulation_time_motherboardfrontpanel_layout);
        ConstraintLayout motherboard_frontpanelcable_layout = view.findViewById(R.id.simulation_time_motherboardfrontpanelcable_layout);
        ImageView motherboard_frontpanel = view.findViewById(R.id.simulation_time_motherboardfrontpanel_item);
        ImageView motherboard_frontpanelcable = view.findViewById(R.id.simulation_time_motherboardfrontpanelcable_item);
    ...
    public void taskSeven(View view) {
        ConstraintLayout backviewcaselid_layout = view.findViewById(R.id.simulation_time_backviewcaselid_layout);
        ImageView backviewcaselid_item = view.findViewById(R.id.simulation_time_backviewcaselid_item);
    ...
    public void taskEight(View view) {
        ConstraintLayout storage_layout = view.findViewById(R.id.simulation_time_storage_layout);
        ConstraintLayout ssd_cords_layout = view.findViewById(R.id.simulation_time_ssd_cords_layout);
        ImageView storage = view.findViewById(R.id.simulation_time_storage_item);
        ImageView ssd_psu_cords = view.findViewById(R.id.simulation_time_ssd_cordspsu_item);
        ImageView ssd_sata_cords = view.findViewById(R.id.simulation_time_ssd_cordssata_item);
    ...
    public void taskNine(View view) {
        char screws_gone[] = {'_', '_', '_', '_'};
        ConstraintLayout ssd_screw_layout = view.findViewById(R.id.simulation_time_ssd_screw_layout);
        ImageView screw_1 = view.findViewById(R.id.simulation_time_ssd_screw_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_time_ssd_screw_2);
        ImageView screw_3 = view.findViewById(R.id.simulation_time_ssd_screw_3);
        ImageView screw_4 = view.findViewById(R.id.simulation_time_ssd_screw_4);
    ...
    public void taskTen(View view) {
        ConstraintLayout ssd_ssd_layout = view.findViewById(R.id.simulation_time_ssd_ssd_layout);
        ImageView ssd_ssd = view.findViewById(R.id.simulation_time_ssd_ssd_item);
    ...
    public void taskEleven(View view) {
        ...
        ImageView storage = view.findViewById(R.id.simulation_time_storage_item);
        storage_layout.setVisibility(View.VISIBLE);
        ConstraintLayout hdd_cords_layout = view.findViewById(R.id.simulation_time_hdd_cords_layout);
        ImageView hdd_psu_cords = view.findViewById(R.id.simulation_time_hdd_cordspsu_item);
        ImageView hdd_sata_cords = view.findViewById(R.id.simulation_time_hdd_cordssata_item);
    ...
    public void taskTwelve(View view) {
        ...
        ConstraintLayout hdd_screw_layout = view.findViewById(R.id.simulation_time_hdd_screw_1_layout);
        ImageView screw_1 = view.findViewById(R.id.simulation_time_hdd_screw_1_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_time_hdd_screw_1_2);
        ImageView screw_3 = view.findViewById(R.id.simulation_time_hdd_screw_1_3);
    ...
    public void taskThirteen(View view) {
        char screws_gone[] = {'_', '_', '_'};
        ConstraintLayout hdd_screw_layout = view.findViewById(R.id.simulation_time_hdd_screw_2_layout);
        ImageView screw_1 = view.findViewById(R.id.simulation_time_hdd_screw_2_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_time_hdd_screw_2_2);
        ImageView screw_3 = view.findViewById(R.id.simulation_time_hdd_screw_2_3);
        hdd_screw_layout.setVisibility(View.VISIBLE);
    ...
    public void taskFourteen(View view) {
        ConstraintLayout hdd_hdd_layout = view.findViewById(R.id.simulation_time_hdd_hdd_layout);
        ImageView hdd_hdd = view.findViewById(R.id.simulation_time_hdd_hdd_item);
    ...
    public void taskFifteen(View view) {
        viewPager2.setEnabled(false);
        ConstraintLayout four_pin_layout = view.findViewById(R.id.simulation_time_4pin_layout);
        ImageView four_pin = view.findViewById(R.id.simulation_time_4pin_item);
    ...
    public void taskSixteen(View view) {
        viewPager2.setEnabled(true);
        ConstraintLayout sata_layout = view.findViewById(R.id.simulation_time_sata_layout);
        sata_layout.setVisibility(View.VISIBLE);
        ImageView sata_1 = view.findViewById(R.id.simulation_time_sata_1);
        ImageView sata_2 = view.findViewById(R.id.simulation_time_sata_2);
    ...
    public void taskSeventeen(View view) {
        char screws_gone[] = {'_', '_', '_', '_'};
        ConstraintLayout psu_screw_layout = view.findViewById(R.id.simulation_time_psu_screw_layout);
        ImageView screw_1 = view.findViewById(R.id.simulation_time_psu_screw_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_time_psu_screw_2);
        ImageView screw_3 = view.findViewById(R.id.simulation_time_psu_screw_3);
        ImageView screw_4 = view.findViewById(R.id.simulation_time_psu_screw_4);
    ...
    public void taskEighteen(View view) {
        ConstraintLayout psu_layout = view.findViewById(R.id.simulation_time_psu_layout);
        ImageView psu = view.findViewById(R.id.simulation_time_psu_item);
    ...
    public void taskNineteen(View view) {
        ...
        ConstraintLayout vc_screw_layout = view.findViewById(R.id.simulation_time_vc_screw_layout);
        ImageView screw_1 = view.findViewById(R.id.simulation_time_vc_screw_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_time_vc_screw_2);
        ConstraintLayout mobo_vc_screw_layout = view.findViewById(R.id.simulation_time_mobo_vcscrew_layout);
        mobo_vc_screw_layout.setVisibility(View.VISIBLE);
        ImageView mobo_vc_screw = view.findViewById(R.id.simulation_time_mobo_vcscrew);
    ...
    public void taskTwenty(View view) {
        ConstraintLayout vc_layout = view.findViewById(R.id.simulation_time_vc_layout);
        ImageView vc = view.findViewById(R.id.simulation_time_vc_item);
    ...
    public void taskTwentyOne(View view) {
        ConstraintLayout mobo_ram_layout = view.findViewById(R.id.simulation_time_mobo_ram_layout);
        mobo_ram_layout.setVisibility(View.VISIBLE);
        ImageView mobo_ram = view.findViewById(R.id.simulation_time_mobo_ram_item);
    ...
    public void taskTwentyTwo(View view) {
        ...
        ConstraintLayout ram_layout = view.findViewById(R.id.simulation_time_ram_layout);
        ImageView ram_1 = view.findViewById(R.id.simulation_time_ram_1);
        ImageView ram_2 = view.findViewById(R.id.simulation_time_ram_2);
        ImageView ram_3 = view.findViewById(R.id.simulation_time_ram_3);
        ImageView ram_4 = view.findViewById(R.id.simulation_time_ram_4);
    ...
    public void taskTwentyThree(View view) {
        viewPager2.setEnabled(false);
        ConstraintLayout heatsink_layout = view.findViewById(R.id.simulation_time_heatsink_cable_layout);
        ImageView heatsink = view.findViewById(R.id.simulation_time_heatsink_cable_item);
        ConstraintLayout mobo_heatsink_layout = view.findViewById(R.id.simulation_time_mobo_heatsink_layout);
        mobo_heatsink_layout.setVisibility(View.VISIBLE);
        ImageView mobo_heatsink = view.findViewById(R.id.simulation_time_mobo_heatsink_item);
    ...
    public void taskTwentyFour(View view) {
        viewPager2.setEnabled(true);
        char screws_gone[] = {'_', '_'};
        ConstraintLayout heatink_screw_layout = view.findViewById(R.id.simulation_time_heatsink_screw_1_layout);
        heatink_screw_layout.setVisibility(View.VISIBLE);
        ImageView screw_1 = view.findViewById(R.id.simulation_time_heatsink_screw_1_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_time_heatsink_screw_1_2);
    ...
    public void taskTwentyFive(View view) {
        char screws_gone[] = {'_', '_'};
        ConstraintLayout heatink_screw_layout = view.findViewById(R.id.simulation_time_heatsink_screw_2_layout);
        heatink_screw_layout.setVisibility(View.VISIBLE);
        ImageView screw_1 = view.findViewById(R.id.simulation_time_heatsink_screw_2_1);
        ImageView screw_2 = view.findViewById(R.id.simulation_time_heatsink_screw_2_2);
    ...
    public void taskTwentySix(View view) {
        ConstraintLayout hs_layout = view.findViewById(R.id.simulation_time_heatsink_layout);
        ImageView hs = view.findViewById(R.id.simulation_time_heatsink_item);
    ...
    public void taskTwentySeven(View view) {
        ConstraintLayout handle_layout = view.findViewById(R.id.simulation_time_cpu_handle_layout);
        ImageView handle = view.findViewById(R.id.simulation_time_cpu_handle);
    ...
    public void taskTwentyEight(View view) {
        ConstraintLayout cpu_layout = view.findViewById(R.id.simulation_time_cpu_layout);
        ImageView cpu = view.findViewById(R.id.simulation_time_cpu);
    ...
    public void taskTwentyNine(View view) {
        char screws_gone[] = {'_', '_', '_'};
        ConstraintLayout screw_1_1_layout = view.findViewById(R.id.simulation_time_mobo_screws_1_1_layout);
        ConstraintLayout screw_1_2_layout = view.findViewById(R.id.simulation_time_mobo_screws_1_2_layout);
        ConstraintLayout screw_1_3_layout = view.findViewById(R.id.simulation_time_mobo_screws_1_3_layout);
        ConstraintLayout screw_2_1_layout = view.findViewById(R.id.simulation_time_mobo_screws_2_1_layout);
        ConstraintLayout screw_2_2_layout = view.findViewById(R.id.simulation_time_mobo_screws_2_2_layout);
        ConstraintLayout screw_3_1_layout = view.findViewById(R.id.simulation_time_mobo_screws_3_1_layout);
        ConstraintLayout screw_3_2_layout = view.findViewById(R.id.simulation_time_mobo_screws_3_2_layout);
        ConstraintLayout screw_3_3_layout = view.findViewById(R.id.simulation_time_mobo_screws_3_3_layout);
        ImageView screw_1_1 = view.findViewById(R.id.simulation_time_mobo_screws_1_1);
        ImageView screw_1_2 = view.findViewById(R.id.simulation_time_mobo_screws_1_2);
        ImageView screw_1_3 = view.findViewById(R.id.simulation_time_mobo_screws_1_3);
        ImageView screw_2_1 = view.findViewById(R.id.simulation_time_mobo_screws_2_1);
        ImageView screw_2_2 = view.findViewById(R.id.simulation_time_mobo_screws_2_2);
        ImageView screw_3_1 = view.findViewById(R.id.simulation_time_mobo_screws_3_1);
        ImageView screw_3_2 = view.findViewById(R.id.simulation_time_mobo_screws_3_2);
        ImageView screw_3_3 = view.findViewById(R.id.simulation_time_mobo_screws_3_3);
        ConstraintLayout layout = view.findViewById(R.id.simulation_time_mobo_screws_layout);
        ImageView one = view.findViewById(R.id.simulation_time_mobo_screws_1);
        ImageView two = view.findViewById(R.id.simulation_time_mobo_screws_2);
        ImageView three = view.findViewById(R.id.simulation_time_mobo_screws_3);
    ...
    public void taskThirty(View view) {
        ConstraintLayout layout = view.findViewById(R.id.simulation_time_motherboard_layout);
        layout.setVisibility(View.VISIBLE);
        ImageView image = view.findViewById(R.id.simulation_time_motherboard_item);
    ...
    public void taskThirtyOne(View view) {
        ImageView item_real = view.findViewById(R.id.simulation_time_item);
        item_real.setVisibility(View.VISIBLE);
        ImageView item = view.findViewById(R.id.simulation_time_item_image);
    ...
    public void taskThirtyTwo(View view) {
        View motherboard_drag = view.findViewById(R.id.simulation_time_motherboard_disassemble);
    ...
    public void taskThirtyThree(View view) {
        ...
        screw_no--;
        View motherboard_screw_1 = view.findViewById(R.id.simulation_time_mobo_screws_1_disassemble);
        View motherboard_screw_2 = view.findViewById(R.id.simulation_time_mobo_screws_2_disassemble);
        View motherboard_screw_3 = view.findViewById(R.id.simulation_time_mobo_screws_3_disassemble);
        ...
        View screw_1_1 = view.findViewById(R.id.simulation_time_mobo_screws_1_1_disassemble);
        View screw_1_2 = view.findViewById(R.id.simulation_time_mobo_screws_1_2_disassemble);
        View screw_1_3 = view.findViewById(R.id.simulation_time_mobo_screws_1_3_disassemble);
        View screw_2_1 = view.findViewById(R.id.simulation_time_mobo_screws_2_1_disassemble);
        View screw_2_2 = view.findViewById(R.id.simulation_time_mobo_screws_2_2_disassemble);
        View screw_3_1 = view.findViewById(R.id.simulation_time_mobo_screws_3_1_disassemble);
        View screw_3_2 = view.findViewById(R.id.simulation_time_mobo_screws_3_2_disassemble);
        View screw_3_3 = view.findViewById(R.id.simulation_time_mobo_screws_3_3_disassemble);
    ...
    public void taskThirtyFour(View view) {
        View cpu_drag = view.findViewById(R.id.simulation_time_cpu_disassemble);
    ...
    public void taskThirtyFive(View view) {
        View handle = view.findViewById(R.id.simulation_time_cpu_handle_disassemble);
    ...
    public void taskThirtySix(View view) {
        View heatsink_drag = view.findViewById(R.id.simulation_time_heatsink_item_disassemble);
    ...
    public void taskThirtySeven(View view) {
        View screw_1 = view.findViewById(R.id.simulation_time_heatsink_screw_2_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_time_heatsink_screw_2_2_disassemble);
    ...
    public void taskThirtyEight(View view) {
        View screw1 = view.findViewById(R.id.simulation_time_heatsink_screw_1_1_disassemble);
        View screw2 = view.findViewById(R.id.simulation_time_heatsink_screw_1_2_disassemble);
    ...
    public void taskThirtyNine(View view) {
        ImageView cable = view.findViewById(R.id.simulation_time_heatsink_cable_item_disassemble);
        View cable_drag = view.findViewById(R.id.simulation_time_heatsink_cable_drag_disassemble);
    ...
    public void taskForty(View view) {
        View mobo_ram = view.findViewById(R.id.simulation_time_mobo_ram_item_disassemble);
    ...
    public void taskFortyOne(View view) {
        View ram1 = view.findViewById(R.id.simulation_time_ram_disassemble);
    ...
    public void taskFortyThree(View view) {
        View vc = view.findViewById(R.id.simulation_time_videocard_disassemble);
    ...
    public void taskFortyFour(View view) {
        View videocard = view.findViewById(R.id.simulation_time_vc_item_disassemble);
    ...
    public void taskFortyFive(View view) {
        View screw1 = view.findViewById(R.id.simulation_time_vc_screw_1_disassemble);
        View screw2 = view.findViewById(R.id.simulation_time_vc_screw_2_disassemble);
        screw1.setVisibility(View.VISIBLE);
        screw2.setVisibility(View.VISIBLE);
    ...
    public void taskFortySix(View view) {
        View psu = view.findViewById(R.id.simulation_time_psu_item_disassemble);
    ...
    public void taskFortySeven(View view) {
        ...
        View screw_1 = view.findViewById(R.id.simulation_time_psu_screw_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_time_psu_screw_2_disassemble);
        View screw_3 = view.findViewById(R.id.simulation_time_psu_screw_3_disassemble);
        View screw_4 = view.findViewById(R.id.simulation_time_psu_screw_4_disassemble);
        screw_1.setVisibility(View.VISIBLE);
        screw_2.setVisibility(View.VISIBLE);
    ...
    public void taskFortyEight(View view) {
        View sata = view.findViewById(R.id.simulation_time_sata_1_disassemble);
    ...
    public void taskFortyNine(View view) {
        ImageView cable = view.findViewById(R.id.simulation_time_4pin_disassemble);
        View cable_drag = view.findViewById(R.id.simulation_time_4pin_item_disassemble);
        cable_drag.setVisibility(View.VISIBLE);
        cable.setVisibility(View.VISIBLE);
    ...
    public void taskFifty(View view) {
        View storage = view.findViewById(R.id.simulation_time_storage_item_disassemble);
    ...
    public void taskFiftyOne(View view) {
        View hdd = view.findViewById(R.id.simulation_time_hdd_hdd_item_disassemble);
    ...
    public void taskFiftyTwo(View view) {
        char screws_gone[] = {'1', '2', '3'};
        View screw_1 = view.findViewById(R.id.simulation_time_hdd_screw_2_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_time_hdd_screw_2_2_disassemble);
        View screw_3 = view.findViewById(R.id.simulation_time_hdd_screw_2_3_disassemble);
        screw_1.setVisibility(View.VISIBLE);
        screw_2.setVisibility(View.VISIBLE);
        screw_3.setVisibility(View.VISIBLE);
    ...
    public void taskFiftyThree(View view) {
        char screws_gone[] = {'1', '2', '3'};
        View screw_1 = view.findViewById(R.id.simulation_time_hdd_screw_1_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_time_hdd_screw_1_2_disassemble);
        View screw_3 = view.findViewById(R.id.simulation_time_hdd_screw_1_3_disassemble);
        screw_1.setVisibility(View.VISIBLE);
        screw_2.setVisibility(View.VISIBLE);
        screw_3.setVisibility(View.VISIBLE);
    ...
    public void taskFiftyFour(View view) {
        ImageView psu = view.findViewById(R.id.simulation_time_hdd_cordspsu_disassemble);
        ImageView sata = view.findViewById(R.id.simulation_time_hdd_cordssata_disassemble);
        View psu_drag = view.findViewById(R.id.simulation_time_hdd_cordspsu_item_disassemble);
        View sata_drag = view.findViewById(R.id.simulation_time_hdd_cordssata_item_disassemble);
        psu.setVisibility(View.VISIBLE);
        sata.setVisibility(View.VISIBLE);
    ...
    public void taskFiftySix(View view) {
        View ssd = view.findViewById(R.id.simulation_time_ssd_ssd_item_disassemble);
    ...
    public void taskFiftySeven(View view) {
        char screws_gone[] = {'1', '2', '3', '4'};
        View screw_1 = view.findViewById(R.id.simulation_time_ssd_screw_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_time_ssd_screw_2_disassemble);
        View screw_3 = view.findViewById(R.id.simulation_time_ssd_screw_3_disassemble);
        View screw_4 = view.findViewById(R.id.simulation_time_ssd_screw_4_disassemble);
        screw_1.setVisibility(View.VISIBLE);
        screw_2.setVisibility(View.VISIBLE);
        screw_3.setVisibility(View.VISIBLE);
        screw_4.setVisibility(View.VISIBLE);
    ...
    public void taskFiftyEight(View view) {
        ImageView psu = view.findViewById(R.id.simulation_time_ssd_cordspsu_disassemble);
        ImageView sata = view.findViewById(R.id.simulation_time_ssd_cordssata_disassemble);
        View psu_drag = view.findViewById(R.id.simulation_time_ssd_cordspsu_item_disassemble);
        View sata_drag = view.findViewById(R.id.simulation_time_ssd_cordssata_item_disassemble);
        psu.setVisibility(View.VISIBLE);
        sata.setVisibility(View.VISIBLE);
        psu_drag.setVisibility(View.VISIBLE);
        sata_drag.setVisibility(View.VISIBLE);
    ...
    public void taskFiftyNine(View view) {
        View backcase_lid = view.findViewById(R.id.simulation_time_backviewcaselid_item_disassemble);
    ...
    public void taskSixty(View view) {
        View frontcable = view.findViewById(R.id.simulation_time_motherboardfrontpanel_item_disassemble);
    ...
    public void taskSixtyOne(View view) {
        ImageView frontcable = view.findViewById(R.id.simulation_time_motherboardfrontpanelcable_disassemble);
        View frontcable_drag = view.findViewById(R.id.simulation_time_motherboardfrontpanelcable_item_disassemble);
        frontcable.setVisibility(View.VISIBLE);
    ...
    public void taskSixtyTwo(View view) {
        View sata = view.findViewById(R.id.simulation_time_motherboardsata_item_disassemble);
        sata.setVisibility(View.VISIBLE);
    ...
    public void taskSixtyThree(View view) {
        ImageView sata_1 = view.findViewById(R.id.simulation_time_motherboardpsatacables_1_disassemble);
        ImageView sata_2 = view.findViewById(R.id.simulation_time_motherboardpsatacables_2_disassemble);
        View sata_1_drag = view.findViewById(R.id.simulation_time_motherboardpsatacables_1_item_disassemble);
        View sata_2_drag = view.findViewById(R.id.simulation_time_motherboardpsatacables_2_item_disassemble);
    ...
    public void taskSixtyFour(View view) {
        View four_pin = view.findViewById(R.id.simulation_time_motherboardpsucables_4pin_disassemble);
        View twentyfour_pin = view.findViewById(R.id.simulation_time_motherboardpsucables_24pin_disassemble);
        four_pin.setVisibility(View.VISIBLE);
        twentyfour_pin.setVisibility(View.VISIBLE);
        View twentyfour_pin_drag = view.findViewById(R.id.simulation_time_motherboardpsucables24pin_item_disassemble);
        View four_pin_drag = view.findViewById(R.id.simulation_time_motherboardpsucables4pin_item_disassemble);
        ImageView twentyfour_pin_item = view.findViewById(R.id.simulation_time_motherboardpsucables24pin_disassemble);
        ImageView four_pin_item = view.findViewById(R.id.simulation_time_motherboardpsucables4pin_disassemble);
    ...
    public void taskSixtyFive(View view) {
        View frontcase_lid = view.findViewById(R.id.simulation_time_frontcaselid_item_disassemble);
    ...
    public void taskSixtySix(View view) {
        char screws_gone[] = {'1', '2', '3', '4'};
        View screw_1 = view.findViewById(R.id.simulation_time_case_screw_1_disassemble);
        View screw_2 = view.findViewById(R.id.simulation_time_case_screw_2_disassemble);
        View screw_3 = view.findViewById(R.id.simulation_time_case_screw_3_disassemble);
        View screw_4 = view.findViewById(R.id.simulation_time_case_screw_4_disassemble);
        screw_1.setVisibility(View.VISIBLE);
        screw_2.setVisibility(View.VISIBLE);
        screw_3.setVisibility(View.VISIBLE);
        screw_4.setVisibility(View.VISIBLE);
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    public void done() {
        int finish_minutes = minutes;
        int finish_seconds = seconds;
        ...
        text.setText("Congratulation!!\n Your time is: " + finish_minutes + ":" + finish_seconds);
        ...
        String status = database.viewSimulationStatus("Time");
        switch (status) {
            case "Active":
                database.updateSimulationStatus("Time", "Done");
                break;
        }

        int total_seconds = (finish_seconds * 60) + finish_seconds;
        int last_fastest_total_sec = (database.getFastestMinutes() * 60) + database.getFastestSeconds();
        int last_slowest_total_sec = (database.getSlowestMinutes() * 60) + database.getSlowestSeconds();

        if (last_fastest_total_sec == 0) {
            database.updateFastest(finish_minutes, finish_seconds);
            if (isConnectedToInternet() == true) {
                php_Update("Highest", finish_minutes, finish_seconds);
            }
        } else if (last_fastest_total_sec == 0) {
            if (total_seconds > last_slowest_total_sec && total_seconds > last_fastest_total_sec) {
                database.updateSlowest(finish_minutes, finish_seconds);
                if (isConnectedToInternet() == true) {
                    php_Update("Lowest", finish_minutes, finish_seconds);
                }
            } else if (total_seconds < last_fastest_total_sec) {
                database.updateSlowest(database.getFastestMinutes(), database.getFastestSeconds());
                if (isConnectedToInternet() == true) {
                    php_Update("Lowest", database.getFastestMinutes(), database.getFastestSeconds());
                }
                database.updateFastest(finish_minutes, finish_seconds);
                if (isConnectedToInternet() == true) {
                    php_Update("Highest", finish_minutes, finish_seconds);
        ...
        } else if (total_seconds > last_slowest_total_sec) {
            database.updateSlowest(finish_minutes, finish_seconds);
            if (isConnectedToInternet() == true) {
                php_Update("Lowest", finish_minutes, finish_seconds);
            }
    ...
    private void php_Update(String status, int minutes, int seconds) {
        ...
        class getLogin extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    URL url = new URL("https://pcad-gbbs.000webhostapp.com/android/android_update_simulation_time.php");
                    ...
                    String post_data = URLEncoder.encode("student_id", "UTF-8") + "=" + URLEncoder.encode(database.get_ID(), "UTF-8") + "&"
                            ...
                            + URLEncoder.encode("minutes", "UTF-8") + "=" + URLEncoder.encode(String.valueOf(minutes), "UTF-8") + "&"
                            + URLEncoder.encode("seconds", "UTF-8") + "=" + URLEncoder.encode(String.valueOf(seconds), "UTF-8");
